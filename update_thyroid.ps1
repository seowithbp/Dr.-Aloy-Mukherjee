$html = Get-Content -Raw -Encoding UTF8 "thyroid-surgery.html"

$r1_find = @"
    <title>Thyroid Surgery in Delhi | Dr. Aloy Mukherjee</title>
    <meta name="description" content="Expert thyroid surgery in Delhi by Dr. Aloy Mukherjee. Advanced minimally invasive treatment for goiter, thyroid nodules, and thyroid cancer." />
"@
$r1_replace = @"
    <title>Thyroid Surgery in Delhi | Dr. Aloy Mukherjee</title>
...
$r2_find = @"
                      <h2 style="font-size: 2.8rem; font-weight: 800; color: #1a1a1a; margin-bottom: 25px;">Understanding Thyroid Disorders</h2>
...
"@
$r2_replace = @"
                      <h2 style="font-size: 2.8rem; font-weight: 800; color: #1a1a1a; margin-bottom: 25px;">Understanding Thyroid Surgery</h2>
...
$r5_find = @"
              <p style="max-width: 800px; margin: 0 auto 40px; font-size: 1.1rem;">To definitively diagnose Thyroid Disorders and rule out other causes, our clinic utilizes comprehensive testing.</p>
              <div class="grid-3">
...
$r7_find = @"
            <h2 class="section-title">Why Dr. Aloy Mukherjee is the Best <span>Thyroid Surgeon</span> in Delhi?</h2>
...
"@
$r7_replace = @"
            <h2 class="section-title">Why Choose Dr. Aloy Mukherjee for <span>Thyroid Surgery?</span></h2>
...
Set-Content -Path "thyroid-surgery.html" -Value $html -Encoding UTF8
